...
/// In dev mode: $DESKTOP_FRONTEND_URL (e.g. http://localhost:3002)
/// In production: http://localhost:3002 (tauri-plugin-localhost serves the app at this port)
/// IMPORTANT: Must match the port used in tauri_plugin_localhost::Builder::new(3002)

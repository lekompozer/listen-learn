        ...
        <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <p className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-900'}`}>
                                {t('Xin chào! Tôi là Trợ lý AI từ WynAI. Tôi có thể giúp gì bạn hôm nay?.', 'Hello! I am an AI assistant from WynAI. How may I assist you today?.')}
                                {' '}
            ...
            {allChatMessages.map((message, index: number) => (
                <div key={index} className={
                    ...
                    <div className="flex items-start space-x-3">
                        {message.type !== 'user' && (
                            <div className={`w-6 h-6 rounded-full flex items-center justify-center text-white text-xs font-medium ${message.type === 'loading'
                                ? 'bg-yellow-600'
                                : message.type === 'ai-edit'
                                    ? 'bg-purple-600'
                                    : 'bg-green-600'
                                }`}>
                                {message.type === 'loading' ? '⏳' : 'AI'}
                            </div>
                        )}

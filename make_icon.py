...
src = Image.open("/Users/user/Code/listen-learn/src-tauri/icons/icon-FoxLearn-Eng.png").convert("RGB")
fox_size = int(W * 0.82)
...
bg_crop = bg_arr[y_off:y_off + fox_size, x_off:x_off + fox_size]   # (fox_size, fox_size, 3)
...
result.resize((32, 32), Image.LANCZOS).save("/Users/user/Code/listen-learn/src-tauri/icons/32x32.png")
result.resize((64, 64), Image.LANCZOS).save("/Users/user/Code/listen-learn/src-tauri/icons/64x64.png")
result.resize((128, 128), Image.LANCZOS).save("/Users/user/Code/listen-learn/src-tauri/icons/128x128.png")
result.resize((256, 256), Image.LANCZOS).save("/Users/user/Code/listen-learn/src-tauri/icons/128x128@2x.png")
...
result.resize((50, 50), Image.LANCZOS).save("/Users/user/Code/listen-learn/src-tauri/icons/StoreLogo.png")

# Also save a 512x512 for use on the download page
result.resize((512, 512), Image.LANCZOS).save("/Users/user/Code/listen-learn/src-tauri/icons/icon-512.png")
